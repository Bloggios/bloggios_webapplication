    ...
    const HeadingContent = () => {
        return (
            <>
                ...
                <span className={'gradient__dark-orange'}>Development</span>
            </>
        )
    }
    return (
        <Wrapper ref={wrapperRef}>
            <ServicesBase
                ...
                description={'Supercharge your business with our custom software solutions, designed to unleash innovation and exceed expectations.'}
...
export default ProductDevelopmentOutlet;