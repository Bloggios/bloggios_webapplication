...
import {bloggiosPostHelpSupport} from "../../../asset/configurations/BloggiosPostHelpSupport";

const BloggiosPostHelpOutlet = () => {
    ...
    return (
        <Wrapper>
            ...
            <AccordionContainer>
                {bloggiosPostHelpSupport.map((item) => (
                    <Accordion
                        key={item.id}
                        data={item}
...
export default BloggiosPostHelpOutlet;