...
import {bloggiosMessagingHelpData} from "../../../asset/configurations/BloggiosMessagingHelpSupport";

const BloggiosMessagingHelpOutlet = () => {
    ...
    return (
        <Wrapper>
            ...
            <AccordionContainer>
                {bloggiosMessagingHelpData.map((item) => (
                    <Accordion
                        key={item.id}
                        data={item}
...
export default BloggiosMessagingHelpOutlet;