...
export const PROFILE_POST_OUTLET_PAGE = 'posts';
...
export const BLOGGIOS_MESSAGING_HELP = 'bloggios-messaging';
export const BLOGGIOS_POST_HELP = 'bloggios-post';
export const BLOGGIOS_OTHERS_HELP = 'bloggios-others';
